...
export async function generateStaticParams() {
  ...
  const res = await client.getEntries({ content_type: 'featuredProducts' });
...
const getSingleProduct=async ({id})=>{
  try {
    ...
    const response=await client.getEntries({content_type:'featuredProducts','sys.id':id})
...
const relatedProducts=await getRelatedProducts({id})
  return (
    ...
    <RelatedProducts relatedProducts={relatedProducts} page={'featured-products'}/>
  </>
  )
}
